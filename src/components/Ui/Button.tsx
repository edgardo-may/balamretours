...
const Button: FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: 'bg-teal-600 text-black hover:bg-teal-700 focus:ring-teal-500 shadow-lg shadow-teal-600/20',
    secondary: 'bg-slate-900 text-black hover:bg-slate-800 focus:ring-slate-700',
