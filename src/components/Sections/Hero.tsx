      ...
      <div className="container mx-auto px-6 relative z-20">
        <div className="max-w-3xl">
          ...
          >
            ...
            >
              Vive la <span className="text-teal-400">Aventura</span> de tu Vida.
            </motion.h1>
            ...
            >
              Explora cenotes cristalinos, ciudades mayas milenarias y la selva virgen con guías certificados.
            </motion.p>
